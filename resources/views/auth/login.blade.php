<x-guest-layout>
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-bold text-gray-900">Portal Akademik</h2>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <div class="relative mt-1">
                ...
                <x-text-input id="username" class="block w-full pl-10"
                    type="text"
                    name="username"
                    :value="old('username')"
        ...
        <div class="mt-6">
            <x-primary-button class="w-full justify-center py-3 text-base font-bold shadow-lg shadow-indigo-500/30 transition-transform transform hover:scale-[1.02]">
                {{ __('Masuk Sistem') }}
            </x-primary-button>
        </div>
