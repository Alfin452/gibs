<aside class="w-72 bg-gradient-to-b from-blue-900 to-blue-950 border-r border-blue-800 min-h-screen fixed left-0 top-0 hidden md:flex flex-col z-20 shadow-xl transition-all duration-300 text-white">
    ...
    {{-- HEADER / LOGO --}}
    <div class="h-24 flex items-center px-6 border-b border-white/5 relative overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

        <a href="{{ route('dashboard') }}" class="flex items-center gap-4 group relative z-10 w-full">
            ...
            <div class="flex flex-col">
                <h1 class="text-xl font-bold text-white tracking-tight leading-none group-hover:text-cyan-300 transition-colors">
                    GIBS<span class="text-blue-500">.</span>Portal
                </h1>
                <div class="flex items-center gap-2 mt-1">
                    <span class="text-[9px] font-medium uppercase tracking-[0.2em] text-blue-400">Academic System</span>
                </div>
            </div>
        </a>
    </div>
