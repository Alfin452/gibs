...
<body class="font-sans antialiased bg-[#F9FAFB] text-slate-900 selection:bg-primary-500 selection:text-white">
    ...
    <div class="min-h-screen flex flex-row relative">
        ...
        <aside class="w-72 bg-gradient-to-b from-primary-900 to-primary-950 border-r border-primary-800 min-h-screen fixed left-0 top-0 hidden md:flex flex-col z-30 shadow-xl transition-all duration-300 text-white">
            ...
            <nav class="flex-1 px-4 py-8 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <div class="px-4 mb-4">
                    <span class="text-[10px] font-bold text-primary-300/80 uppercase tracking-widest">Main Menu</span>
                </div>
                ...
                <div class="px-4 mt-8 mb-4">
                    <span class="text-[10px] font-bold text-primary-300/80 uppercase tracking-widest">Kelola Data</span>
                </div>
                ...
                <div class="flex items-center justify-between gap-3 p-3 rounded-2xl bg-primary-900/50 border border-primary-800 group hover:border-primary-700 hover:shadow-lg hover:bg-primary-900 transition-all duration-300">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="flex flex-col min-w-0">
                            ...
                            <p class="text-[10px] text-primary-200 font-medium truncate capitalize">
                                {{ Auth::user()->role ?? 'Guru' }}
                            </p>
                        </div>
                    </div>
        ...
        document.addEventListener('submit', function(e) {
            if (e.target && e.target.action && e.target.action.includes('logout')) {
                ...
                Swal.fire({
                    ...
                    confirmButtonColor: '#3ab09e', // Disesuaikan dengan warna Keppel (Primary)
